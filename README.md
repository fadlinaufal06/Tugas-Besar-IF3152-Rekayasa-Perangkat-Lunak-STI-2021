...
<img src="./doc/daftarperalatan.png" alt="daftarperalatan.png" width="800"/>

<img src="./doc/edit_peralatan.png" alt="edit_peralatan.png" width="800"/>
...
<img src="./doc/daftarmenu.png" alt="daftarmenu.png" width="800"/>

<img src="./doc/editmenu.png" alt="editmenu.png" width="800"/>
...
<img src="./doc/todolist.png" alt="todolist.png" width="800"/>

<img src="./doc/edit_todolist.png" alt="edit_todolist.png" width="800"/>

# DAFTAR TABEL BASIS DATA

## LOGIN/REGISTER
MariaDB [monitros]> select * from data_user;
+----------------+-------------+-----------------+------------+------------+----------+
...
## DAFTAR/EDIT PERALATAN
MariaDB [monitros]> select * from peralatan;
+-------------+----------------+----------------+--------------+------------------+-----------------+
...
## DAFTAR/EDIT MENU
MariaDB [monitros]> select * from menu;
+--------+-------------+------------------------+
...
## TODOLIST
MariaDB [monitros]> select * from todolist;
+-------------+----------------+----------+-----------------+--------------------------------------------+-----------------+
